...
class baseConfig {
  ...
  public static final String[] APPS = ['issuer-kit-db', 'issuer-kit-wallet', 'issuer-kit-admin', 'issuer-kit-web', 'issuer-kit-agent', 'issuer-kit-api']

  // Apps - Listed in the order they should be tagged for deployment
  public static final String[] DEPLOY_APPS = ['issuer-kit-db', 'issuer-kit-wallet', 'issuer-kit-admin', 'issuer-kit-web', 'issuer-kit-agent', 'issuer-kit-api']
}